                        ...
                        try {
                            ...
                            if (tableAnhList.size() != 0) {
                                ...
                                if (!TextUtils.isEmpty(TEN_ANH_CTO_TREO)) {
                                    String PATH_ANH = Common.getRecordDirectoryFolder(Common.FOLDER_NAME.FOLDER_ANH_CONG_TO.name()) + "/" + TEN_ANH_CTO_TREO;
                            ...
                            if (tableAnhList.size() != 0) {
                                ...
                                if (!TextUtils.isEmpty(TEN_ANH_CTO_THAO)) {
                                    PATH_ANH = Common.getRecordDirectoryFolder(Common.FOLDER_NAME.FOLDER_ANH_CONG_TO.name()) + "/" + TEN_ANH_CTO_THAO;
